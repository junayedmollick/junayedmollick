...
- Frontend developer focused on building clean, responsive, interactive web experiences.
- Working mainly with **React, Vite, JavaScript and Tailwind CSS**.
- Exploring **AI-powered applications, Python automation and desktop tools**.
- Interested in modern UI/UX, performance, animations and scalable frontend architecture.
- Building projects across **fintech, e-commerce, education and AI**.
- Always learning, experimenting and improving through real projects.
...
### Frontend
<img src="https://skillicons.dev/icons?i=html,css,js,react,vite,tailwind" alt="Frontend skills" />

### Development & Tools
<img src="https://skillicons.dev/icons?i=nodejs,python,git,github,vscode,figma,vercel" alt="Development tools" />
...
```text
⚡ Building polished React applications
🤖 Exploring AI assistants and automation
🎨 Improving UI/UX and motion design
...
<sub>Always learning something new and turning it into something useful.</sub>
